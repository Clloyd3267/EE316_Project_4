...
## PL System Clock
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports I_CLK_125_MHZ]
create_clock -period 8.000 -name I_CLK_125_MHZ -waveform {0.000 4.000} -add [get_ports I_CLK_125_MHZ]
...
## Buttons
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVCMOS33} [get_ports I_RESET]
...
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports H]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports V]
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { jb6 }]; #IO_L4P_T0_34 Sch=jb_p[4]
#set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { jb7 }]; #IO_L4N_T0_34 Sch=jb_n[4]
...
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { O_LCD_RS }]; #IO_L11P_T1_SRCC_34 Sch=ck_io[0]
#set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { O_LCD_RW }]; #IO_L3N_T0_DQS_34 Sch=ck_io[1]
#set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { O_LCD_ENABLE }]; #IO_L5P_T0_34 Sch=ck_io[2]
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { O_LCD_DATA[0] }]
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { O_LCD_DATA[1] }];
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { O_LCD_DATA[2] }];
#set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { O_LCD_DATA[3] }];
#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { O_LCD_DATA[4] }];
#set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { O_LCD_DATA[5] }];
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { O_LCD_DATA[6] }];
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { O_LCD_DATA[7] }];
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { ck_io11 }]; #IO_L12N_T1_MRCC_35 Sch=ck_io[11]
set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS33} [get_ports I_PS2_CLK]
set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports I_PS2_DATA]
...
set_property DONT_TOUCH true [get_cells {design_1_i/videomemlab_master_0_axi_periph/xbar/inst/gen_sasd.crossbar_sasd_0/gen_decerr.decerr_slave_inst/gen_no_arbiter.m_grant_hot_i[0]_i_6}]
...
connect_debug_port u_ila_0/probe0 [get_nets [list I_PS2_DATA_IBUF]]
