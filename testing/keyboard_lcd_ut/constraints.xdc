...
create_clock -add -name I_CLK -period 8.00 -waveform {0 4} [get_ports { I_CLK }];#set
...
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { I_PS2_CLK }]; #IO_L14P_T2_AD4P_SRCC_35 Sch=ck_io[12]
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { I_PS2_DATA }]; #IO_L19N_T3_VREF_35 Sch=ck_io[13]
